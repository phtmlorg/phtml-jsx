...
Use [pHTML JSX] in your `phtml.config.js` configuration file:
...
Use [pHTML JSX] in your Webpack configuration:
...
Use [React App Rewire pHTML] and [pHTML JSX] in your
...
Use [pHTML JSX] in your Gulpfile:
...
Use [pHTML JSX] in your Gruntfile:
